...
import 'package:mymusicplayer/widgets/favorites.dart';
...
class DatabaseHelper{
  ...
  String favoritesTable = 'favorite_table';
  String colId = 'id';
  String colTitle = 'displayName';
  String colDescription = 'duration';
  String colDate = 'date';
  ...
  Future<Database> initializeDatabase() async {
    ...
    Directory directory = await p.getApplicationDocumentsDirectory();
    String path = directory.path + 'mp_favorites.db';
...
//		var result = await db.rawQuery('SELECT * FROM $todoTable order by $colTitle ASC');
    var result = await db.query(favoritesTable, orderBy: '$colTitle ASC');
    return result;
  }

  // Insert Operation: Insert a todo object to database
  Future<int> insertTodo(Favorites favorites) async {
    Database db = await this.database;
    var result = await db.insert(favoritesTable, favorites);
    return result;
  }
