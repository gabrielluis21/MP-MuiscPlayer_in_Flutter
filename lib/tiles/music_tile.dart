...
class MusicTile extends StatelessWidget {
  ...
  MusicTile({Key key, @required Music music}) : _music = music, super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MapEntry<PlayerState, Music>>(
        ...
        builder: (context, snapshot) {
          ...
          final bool _isSelectedSong = _music == _currentSong;
  ...
  void parseDuration() {
    final double _temp = _music.duration / 1000;
  ...
  void parseArtists() {
    _artists = _music.artist.split(";").reduce((String a, String b) {
      return a + " & " + b;
    });
  }
}
